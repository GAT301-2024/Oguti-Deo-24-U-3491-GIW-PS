...
const char *ADMIN_PASS = "deo";

// LED pins
int ledPins[3] = {31,30,25};
...
String htmlHeader(const String &title) {
  ...
  h += "h1{background:#004466;color:green;padding:20px 10px;margin:0;font-size:24px;}";
  h += ".container{padding:20px;}";
  h += "button { padding: 10px 20px; font-size: 16px; margin: 5px; cursor: pointer; border: none; }";
  h += ".on { padding: 10px 5px; font-size: 16px; margin: 5px; cursor: pointer; border: none; }";
  h += ".off { padding: 5px 5px; font-size: 16px; margin: 5px; cursor: pointer; border: none; }";
  h += ".logout { padding: 5px 20px; font-size: 16px; margin: 5px; cursor: pointer; border: none; }";
...
// HTML Footer
String htmlFooter() {
  return "<footer>Deo Oguti systems</footer></body></html>";
}
...
String controlPage() {
  ...
  html += "<h1>Logic Loopers</h1><div class='container'>";
